...
>>>>>>> c48bc75 (Initial commit)
>>>>>>> 7796b43 (Second commit)
>>>>>>> bed9b87 (Initial commit)
...
=======
    if existing_sha256 == check_sum:
      print("\033[0;31m%s\033[0m" % "The file has not been modified!")
    else:
      print("\033[0;31m%s\033[0m" % "The file has been modified!")
>>>>>>> c48bc75 (Initial commit)
>>>>>>> 7796b43 (Second commit)
>>>>>>> bed9b87 (Initial commit)
  return 1
...
<<<<<<< HEAD
      'download_url': ( 'https://github.com/OmniSharp/omnisharp-roslyn/release'
=======
      'download_url': ( 'https://github.com/HasturBoss/Tender/release'
>>>>>>> c48bc75 (Initial commit)
>>>>>>> 7796b43 (Second commit)
>>>>>>> bed9b87 (Initial commit)
...
<<<<<<< HEAD
  download_url = ( 'https://github.com/ycm-core/llvm/releases/download/'
                   f'{ CLANGD_VERSION }/{ file_name }' )
=======
  download_url = ( 'https://github.com/HasturBoss/Tender/releases/download/'
                   f'v{ CLANGD_VERSION }/{ file_name }' )
>>>>>>> c48bc75 (Initial commit)
>>>>>>> 7796b43 (Second commit)
>>>>>>> bed9b87 (Initial commit)
...
<<<<<<< HEAD
      sys.exit( 'This script should not be run with sudo.' )
=======
      print( 'This script should not be run with sudo.' )
>>>>>>> c48bc75 (Initial commit)
>>>>>>> 7796b43 (Second commit)
>>>>>>> bed9b87 (Initial commit)
